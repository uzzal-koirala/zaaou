          ...
          {(authorMeta?.twitter_url || authorMeta?.linkedin_url || authorMeta?.website_url) && (
            <div className="mt-4 pt-4 border-t border-border flex justify-center gap-2">
              {authorMeta?.twitter_url && (
                <a href={authorMeta.twitter_url} target="_blank" rel="noopener noreferrer" className="h-8 w-8 grid place-items-center rounded-lg bg-muted hover:bg-primary hover:text-primary-foreground transition-colors">
                  <Twitter className="h-3.5 w-3.5" />
                </a>
              )}
              {authorMeta?.linkedin_url && (
                <a href={authorMeta.linkedin_url} target="_blank" rel="noopener noreferrer" className="h-8 w-8 grid place-items-center rounded-lg bg-muted hover:bg-primary hover:text-primary-foreground transition-colors">

...
export function WhatsAppInlineButton({ className = "" }: { className?: string }) {
  ...
  return (
    <a
      ...
      rel="noopener noreferrer"
      aria-label="Order on WhatsApp"
      className={`group inline-flex items-center gap-2 rounded-xl bg-[oklch(0.65_0.17_150)] hover:bg-[oklch(0.6_0.17_150)] text-white px-7 py-4 font-semibold shadow-soft hover:shadow-glow hover:scale-[1.02] transition-all ${className}`}
    >
